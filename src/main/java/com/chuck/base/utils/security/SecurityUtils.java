...
import com.chuck.base.utils.security.value.BaseUserDetails;
import com.chuck.base.utils.security.value.JwtToken;
...
public class SecurityUtils {
  ...
  public static JwtToken login(
    ...
    claims.put(JwtTokenUtils.USERNAME, username);
    claims.put(JwtTokenUtils.CREATED, new Date());
    claims.put(JwtTokenUtils.AUTHORITIES, authentication.getAuthorities());
    claims.put(JwtTokenUtils.PRINCIPAL, authentication.getPrincipal());
