package com.chuck.base.client.dto.data.country;
...
public enum CountryCode {
    ...
    /**
     * <a href=
     * "http://en.wikipedia.org/wiki/Federated_States_of_Micronesia">Federated
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/British_Virgin_Islands">British Virgin
     * Islands</a>
     */
    ...
    private CountryCode(String name, String alpha3, int numeric) {
        ...
        this.values = Arrays.asList(name(), alpha3, name, numeric + "");
    }

    /**
     * Find the CountryCode by matching against the country code info, it's way
     * slower than getByCode()
     *
     * @param value - can be its Name, alpha2, alpha3 or integer value, case ignored
     * @return null if cannot find or the CountryCode
     */
    // public static CountryCode getMatch(String value) {
    // if (value == null || value.length() == 0) {
    // return null;
    // }
    // value = StringUtils.stripNonAlphaNumeric(value);
    // for (CountryCode enumDef : CountryCode.values()) {
    // for (String cotry : enumDef.getValues()) {
    // cotry = StringUtils.stripNonAlphaNumeric(cotry);
    // if (cotry.compareToIgnoreCase(value) == 0) {
    // return enumDef;
    // }
    // }
    // }
     ...
     * numeric</a> code.
     *
     * @param code An <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric" >ISO
    ...
    // public static boolean isInUS9CodeZone(String value) {
    // CountryCode code = CountryCode.getMatch(value);
    // if (code == null) {
    // return false;
    // } else if (code == CountryCode.AM || code == CountryCode.PR || code ==
    // CountryCode.AS
    // || code == CountryCode.MP
    // || code == CountryCode.VI || code == CountryCode.FM || code == CountryCode.MH
    // || code == CountryCode.PW) {
    // return true;
    // } else {
    // return false;
